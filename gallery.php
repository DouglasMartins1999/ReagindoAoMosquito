<?php session_start();
	...
	$myfile = fopen("http://reagindoaomosquito.pe.hu/includes/weektips/used.txt", "r");
...
<?php include('includes/tags/header.php');?>
  <div class="content" align="center" style="background:#F5F5F5;" id="msg"> 
    ...
    <img src="img/gallery/gallery01.jpg" class="galleryimg"> <img src="img/gallery/gallery02.jpg" class="galleryimg"> 
    <img src="img/gallery/gallery03.jpg" class="galleryimg"> 
    <?php 
	  	foreach($dataN as $id){
			$id = intval($id);
			echo '<a href="galleryimgs.php?id='.$xml->note[$id]->img.'I'.$id.'"><img src="includes/weektips/images/'.$xml->note[$id]->img.'.jpg" class="galleryimg" alt="'.$id.'"></a>';
		}
	  ?>
  </div>
<div class="footer">
