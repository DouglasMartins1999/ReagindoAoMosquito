...
<?php include('includes/tags/header.php');?>
  ...
  <div class="content" style="background:url('img/low-poly.jpg') no-repeat fixed center center / cover;color:#FFF;padding:5% 10%;"> 
    <div id="top" style="left:-50px;position:relative;opacity:0;"> <img src="img/vector.png" class="img-vector"> 
      <h1>A Informação</h1>
...
<div class="content ai bg" style="background:url('img/bg/highlights.jpg');color:#FFF;" align="center"> 
  ...
  <p id="paragh2" style="opacity:0;">Fique informado sobre o mosquito <i>Aedes 
    ...
    <div id="button4" style="top:50px;position:relative;opacity:0;"><a href="interativa.php" class="button">Começar 
      Agora</a></div>
</div>
<div class="content bg" style="background:url('img/bg/bgmap.png');background-repeat:no-repeat;background-size:cover;padding:5% 10% 8% 10%;"> 
  <div class="middlescreen"> 
    ...
    <p id="paragh" style="opacity:0;">Quer saber a situação em que sua rua se 
      ...
      <div id="button3" style="top:50px;position:relative;opacity:0;"><a href="focosmap.php" class="button black">Acessar 
        Mapa</a><br>
        <br>
        <br>
      </div>
...
<div class="content divulgue" align="center"> 
  <div class="bar-divulgue"><img src="img/likebutton.png" style="top: -60px; position: relative;"></div>
  ...
  <p id="vector" style="opacity:0;">Quer ajudar nosso site se popularizar e fazer 
    ...
    <div id="button5" style="left:-50px;position:relative;opacity:0;"><a href="gallery.php" class="button">Acessar a Galeria</a></div>
</div>
<div class="footer">
