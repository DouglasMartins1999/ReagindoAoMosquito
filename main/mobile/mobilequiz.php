...
.home {
	background:url('/assets/images/quiz/bg.jpg');
...
<div class="home cont" id="home">
	<img src="/assets/images/quiz/logo.png" class="logo" onClick="fullscreen();">
	...
	<img src="/assets/images/quiz/ramlogo.png" class="sitelogo">
</div>
...
<div class="cont over none" id="gOver">
	<img src="/assets/images/quiz/gameover.png" class="logo" style="margin-top:27%;margin-bottom:5%" onClick="fullscreen();">
...
<div class="cont high none" id="high">
	...
	<iframe frameborder="0" src="/main/interactive/ranking.php" style="width:100%;height:60%;margin-top:20px;" id="ranking"></iframe>
	<?php $setid = mt_rand(0,3);?>
	<div class="answers">
...
<form action="/services/rankingdata.php" method="post" target="frameform" id="formdata">
