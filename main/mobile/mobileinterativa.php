...
<style>
	...
	.mainmenu {
		background:url('/assets/images/ainter/mobile/bg.jpg');
	}
	.background {
	...
	.redbgadd {
		background:url('/assets/images/ainter/mobile/bg/bgred.jpg');
	}
	.yellowbgadd {
		background:url('/assets/images/ainter/mobile/bg/bgyellow.jpg');
	}
	.greenbgadd {
		background:url('/assets/images/ainter/mobile/bg/bggreen.jpg');
	}
	.bluebgadd {
		background:url('/assets/images/ainter/mobile/bg/bgblue.jpg');
	}
	.none {
		display:none;
	}
	...
	.inBrasil {
		background:url('/assets/images/ainter/mobile/nobrasil.jpg');
		background-size:cover;
	...
	.inWorld {
		background:url('/assets/images/ainter/mobile/nomundo.jpg');
		background-size:cover;
		background-position:bottom;
		width:100%;
		height:20%;
	...
	.inEgito {
		background:url('/assets/images/ainter/mobile/noaedes.jpg');
		background-size:cover;
		background-position:bottom;
		width:100%;
		height:20%;
	...
	.aedesbgabout {
		background:url('/assets/images/ainter/mobile/aedesabout.jpg');
		background-size:cover;
		background-position:center;
	}
	.habits {
  ...
  <div class="proxbuttondiv"> 
	...
	<div class="cont none" id="aedesmain">
		<div class="background yellowbgadd adverbg">
			<img src="/assets/images/ainter/project/aedesicon.png">
		</div>
		<div class="advers">
  ...
  <div class="proxbuttondiv"> 
	...
	<div class="cont none" id="sintomasmain">
		<div class="background greenbgadd adverbg">
			<img src="/assets/images/ainter/project/sintomasicon.png">
		</div>
		<div class="advers">
  ...
  <div class="proxbuttondiv"> 
	...
	<div class="cont none" id="precamain">
		<div class="background bluebgadd adverbg">
			<img src="/assets/images/ainter/project/precaicon.png">
		</div>
		<div class="advers">
			<label>Tomando</label>
		    <h1>As Precauções</h1>
  ...
  <div class="adverbg" style="height:40%;"> 
    <div style="position:relative;width:100%;top:50%;transform:translateY(-57%);" align="center"> 
      <div style="width:270px;"> 
        ...
        <img src="/assets/images/ainter/mobile/aedeschars.jpg" style="width:270px;height:auto;margin:0;max-width:270px;border-radius:5px;border:1px solid #DDD;"> 
      </div>
    </div>
  </div>
	...
	<div class="cont graybg none" id="AedesHabits">
		...
		<div class="adverbg redbgadd background" style="height:50%;">
			<div class="habimg" id="habimg1">
				<img src="/assets/images/ainter/project/sunicon.png" style="margin:10%;">
			</div>
			<div class="habimg" id="habimg2">
				<img src="/assets/images/ainter/project/fruits.png" style="margin:10%;">
			</div>
			<div class="habimg" id="habimg3">
				<img src="/assets/images/ainter/project/virusicon.png" style="margin:10%;">
			</div>
			<div class="habimg" id="habimg4">
				<img src="/assets/images/ainter/project/flyicon.png" style="margin:10%;">
			</div>
  ...
  <div class="proxbuttondiv"> 
	...
	<div class="cont graybg none" id="Sintoma">
        ...
        <div class="stmico" style="top:75px;left:-5px;" onClick="sintoma('vomitos')"></div>
					<img src="/assets/images/ainter/project/Man3dBodyModel.png" style="width:270px;height:auto;margin:0;max-width:270px;">
				</div>
			</div>
		</div>
	...
	<div class="cont graybg none" id="Prevent">
		...
		<div class="adverbg redbgadd background" style="height:40%;">
			<div class="habimg" id="previmg1">
				<img src="/assets/images/ainter/project/prev/1.png" style="margin:10%;">
			</div>
			<div class="habimg" id="previmg2">
				<img src="/assets/images/ainter/project/prev/2.png" style="margin:10%;">
			</div>
			<div class="habimg" id="previmg3">
				<img src="/assets/images/ainter/project/prev/3.png" style="margin:10%;">
			</div>
			<div class="habimg" id="previmg4">
				<img src="/assets/images/ainter/project/prev/4.png" style="margin:10%;">
			</div>
			<div class="habimg" id="previmg5">
				<img src="/assets/images/ainter/project/prev/5.png" style="margin:10%;">
			</div>
			<div class="habimg" id="previmg6">
				<img src="/assets/images/ainter/project/prev/6.png" style="margin:10%;">
			</div>
			<div class="habimg" id="previmg7">
				<img src="/assets/images/ainter/project/prev/7.png" style="margin:10%;">
			</div>
			<div class="habimg" id="previmg8">
				<img src="/assets/images/ainter/project/prev/8.png" style="margin:10%;">
			</div>
			<div class="habimg" id="previmg9">
				<img src="/assets/images/ainter/project/prev/9.png" style="margin:10%;">
			</div>
			<div class="habimg" id="previmg10">
				<img src="/assets/images/ainter/project/prev/10.png" style="margin:10%;">
			</div>
			<div class="habimg" id="previmg11">
				<img src="/assets/images/ainter/project/prev/11.png" style="margin:10%;">
			</div>
			<div class="habimg" id="previmg12">
				<img src="/assets/images/ainter/project/prev/12.png" style="margin:10%;">
			</div>
			<div class="habimg" id="previmg13">
				<img src="/assets/images/ainter/project/prev/13.png" style="margin:10%;">
			</div>
			<div class="habimg" id="previmg14">
				<img src="/assets/images/ainter/project/prev/14.png" style="margin:10%;">
			</div>
			<div class="habimg" id="previmg15">
				<img src="/assets/images/ainter/project/prev/15.png" style="margin:10%;">
			</div>
		</div>
		<div class="advers" style="height:35%;">
