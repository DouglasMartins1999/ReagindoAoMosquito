...
<script>
	...
	function prevenct(){
			...
			switch (number) {
				case 2:
					document.getElementById('previmg').src = '/assets/images/ainter/project/prev/2.png'
					...
					break;
				case 3:
					document.getElementById('previmg').src = '/assets/images/ainter/project/prev/3.png'
					...
					break;
				case 4:
					document.getElementById('previmg').src = '/assets/images/ainter/project/prev/4.png';
					...
					break;
				case 5:
					document.getElementById('previmg').src = '/assets/images/ainter/project/prev/5.png'
					...
					break;
				case 6:
					document.getElementById('previmg').src = '/assets/images/ainter/project/prev/6.png'
					...
					break;
				case 7:
					document.getElementById('previmg').src = '/assets/images/ainter/project/prev/7.png'
					...
					break;
				case 8:
					document.getElementById('previmg').src = '/assets/images/ainter/project/prev/8.png'
					...
					break;
				case 9:
					document.getElementById('previmg').src = '/assets/images/ainter/project/prev/9.png'
					...
					break;
				case 10:
					document.getElementById('previmg').src = '/assets/images/ainter/project/prev/10.png'
					...
					break;
				case 11:
					document.getElementById('previmg').src = '/assets/images/ainter/project/prev/11.png'
					...
					break;
				case 12:
					document.getElementById('previmg').src = '/assets/images/ainter/project/prev/12.png'
					...
					break;
				case 13:
					document.getElementById('previmg').src = '/assets/images/ainter/project/prev/13.png'
					...
					break;
				case 14:
					document.getElementById('previmg').src = '/assets/images/ainter/project/prev/14.png'
					...
					break;
				case 15:
					document.getElementById('previmg').src = '/assets/images/ainter/project/prev/15.png'
...
<body>
	<div class="mainmenu" id="mainmenu" style="background:url('/assets/images/ainter/bg/mainbg.jpg');">
		<img src="/assets/images/ainter/project/Logo.png" class="logomain" id="logomain">
	...
	<div id="doencamain" class="mainmenu" style="background:url('/assets/images/ainter/bg/doencasmainbg.jpg');display:none;">
		<img src="/assets/images/ainter/project/doencaicon.png" class="iconimg" id="doencaimg" style="top:152px;left:115px;">
	...
	<div id="aedesmain" class="mainmenu" style="background:url('/assets/images/ainter/bg/aedesmainbg.jpg');display:none;">
		<img src="/assets/images/ainter/project/aedesicon.png" class="iconimg" id="aedesimg" style="top:114px;left:91px;">
		<div class="titlemain" id="title">
	...
	<div id="sintomasmain" class="mainmenu" style="background:url('/assets/images/ainter/bg/sintomasmainbg.jpg');display:none;">
		<img src="/assets/images/ainter/project/sintomasicon.png" class="iconimg" id="aedesimg" style="top:144px;left:144px;">
		<div class="titlemain" id="title">
	...
	<div id="precamain" class="mainmenu" style="background:url('/assets/images/ainter/bg/precamainbg.jpg');display:none;">
		<img src="/assets/images/ainter/project/precaicon.png" class="iconimg" id="aedesimg" style="left:86px;top:146px;">
		<div class="titlemain" id="title">
			<span>Tomando</span>
			<h1>As Precauções</h1>
		</div>
	...
	<div class="mainmenu" id="AboutAedes" style="background:url('/assets/images/ainter/bg/Aedesabout.jpg');display:none;">
	...
	<div class="mainmenu" id="AedesOrigin" style="background:url('/assets/images/ainter/bg/AedesOrigin.jpg');display:none;" onClick="dimiss('aedesorigininfo')">
	...
	<div class="mainmenu" id="AedesCharacter" style="background:url('/assets/images/ainter/bg/AedesStatus.jpg');display:none;" onClick="dimiss('aedescharinfo')">
	...
	<div class="mainmenu" id="AedesHabits" style="background:url('/assets/images/ainter/bg/Habitos.jpg');display:none;" onClick="dimiss('aedeshabitsinfo')">
		...
		<img src="/assets/images/ainter/project/sunicon.png" style="top:128px;left:193px;position:absolute;display:none;" id="imgicon1">
		<img src="/assets/images/ainter/project/fruits.png" style="top:137px;left:202px;position:absolute;display:none;" id="imgicon2">
		<img src="/assets/images/ainter/project/virusicon.png" style="top:105px;left:175px;position:absolute;display:none;" id="imgicon3">
		<img src="/assets/images/ainter/project/flyicon.png" style="top:78px;left:157px;position:absolute;display:none;" id="imgicon4">
	</div>
	
	<div class="mainmenu" id="AedesTimeline" style="background:url('/assets/images/ainter/bg/AedesTimeline.jpg');display:none;" onClick="dimiss('aedestimeinfo')">
	...
	<div class="mainmenu" id="AedesBreeding" style="background:url('/assets/images/ainter/bg/AedesReprodution.jpg');display:none;" onClick="dimiss('aedesbreedinfo')">
	...
	<div class="mainmenu" id="DengueOrigin" style="background:url('/assets/images/ainter/bg/DengueMap.jpg');display:none;" onClick="dimiss('dengueorigininfo')">
	...
	<div class="mainmenu" id="ZikaOrigin" style="background:url('/assets/images/ainter/bg/ZikaMap.jpg');display:none;">
	...
	<div class="mainmenu" id="ChikOrigin" style="background:url('/assets/images/ainter/bg/ChikMap.jpg');display:none;">
	...
	<div class="mainmenu" id="Sintomas" style="background:url('/assets/images/ainter/bg/Sintomas.jpg');display:none;" onClick="dimiss('sintomainfo')">
		...
		<img src="/assets/images/ainter/project/Man3dBodyModel.png" style="top:87px;left:52px;position:absolute;">
	...
	<div class="mainmenu" id="Prevenir" style="background:url('/assets/images/ainter/bg/Prevenir.jpg');display:none;" onClick="dimiss('preventinfo')">
		...
		<img src="/assets/images/ainter/project/prev/1.png" style="top: 150px;left:140;position:absolute;" id="previmg">
	...
	<div id="doencaFinish" class="mainmenu" style="background:url('/assets/images/ainter/bg/doencasmainbg.jpg');display:none;">
		<img src="/assets/images/ainter/project/doencaicon.png" class="iconimg" id="doencaimg" style="top:152px;left:115px;">
		<div class="titlemain" id="title">
			<span>O problema:</span>
			<h1>As doenças</h1>
	...
	<div id="aedesFinish" class="mainmenu" style="background:url('/assets/images/ainter/bg/aedesmainbg.jpg');display:none;">
		<img src="/assets/images/ainter/project/aedesicon.png" class="iconimg" id="aedesimg" style="top:114px;left:91px;">
		<div class="titlemain" id="title">
			<span>O causador:</span>
			<h1>O Aedes aegypti</h1>
	...
	<div id="sintomasFinish" class="mainmenu" style="background:url('/assets/images/ainter/bg/sintomasmainbg.jpg');display:none;">
		<img src="/assets/images/ainter/project/sintomasicon.png" class="iconimg" id="aedesimg" style="top:144px;left:144px;">
		<div class="titlemain" id="title">
			<span>Identificando</span>
			<h1>Os Sintomas</h1>
	...
	<div id="precaFinish" class="mainmenu" style="background:url('/assets/images/ainter/bg/precamainbg.jpg');display:none;">
		<img src="/assets/images/ainter/project/precaicon.png" class="iconimg" id="aedesimg" style="left:86px;top:146px;">
		<div class="titlemain" id="title">
			<span>Tomando</span>
			<h1>As Precauções</h1>
