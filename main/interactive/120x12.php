...
<?php include('../../helpers/header.php');?>
  <div class="content" align="center" style="background:#F5F5F5;"> 
    ...
    <iframe src="/main/interactive/quiz.php" frameborder="0" scrolling="no" width="800" height="480" align="middle" class="pc"></iframe>
  </div>
  <iframe src="/main/mobile/mobilequiz.php" class="mobile" style="height:100%;width:100%;" frameborder="0" id="quiz" allowfullscreen="true"></iframe>
<div class="footer">
