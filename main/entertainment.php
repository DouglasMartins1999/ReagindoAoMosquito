...
<?php include('../helpers/header.php');?>
  ...
  <div class="content" align="center" style="background:#F5F5F5;padding:2% 10%;"> 
	...
	<div class="interativa square" id="square1">
		...
		<a href="/main/interactive/interativa.php" class="button">Começar Agora</a><br><br><br>
	</div>
	<div class="maps square" id="square2" style="color:#333">
		...
		<a href="/main/interactive/focosmap.php" class="button black">Acessar Mapa</a>
	</div>
	<div class="quiz square" id="square3">
      ...
      cantinho próprio para isso!</p>
		<a href="/main/interactive/120x12.php" class="button">Iniciar Agora</a>
	</div>
