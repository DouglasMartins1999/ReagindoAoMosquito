...
<?php include('../helpers/header.php');?>
  <div class="content" align="center" style="background:#F5F5F5;" id="msg"> 
	...
	<p></p>
	<form id="report" action="/services/report.php" enctype="multipart/form-data" method="post">
		...
		<label for="camera" class="bufiles mobile" id="cam"><img src="/assets/images/390.png" align="absmiddle" style="padding: 0px 10px;">Tirar Foto Agora</label>
		<br>
		<input type="file" name="files" id="files" class="inputfile" onchange="loadFile(event);hide('cam','gallery');">
		<label for="files" class="bufiles mobile" id="gallery"><img src="/assets/images/240.png" align="absmiddle" style="padding: 0px 10px;">Abrir da Galeria</label>
		<label for="files" class="bufiles pc" id="gallery"><img src="/assets/images/240.png" align="absmiddle" style="padding: 0px 10px;">Carregar Foto</label>
		<br><br>
