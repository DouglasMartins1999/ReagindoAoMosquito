...
<style>
	...
	.header {
		background:url('ezgif-4-2e0a6995f5.gif'), url('http://rosalieledda.com/wp-content/uploads/2015/09/warmlowpoly2.png');
	...
	.reacting {
		background:url('back1.jpg'), url('blured1.png');
		background-size:cover;
		background-position:center;
		background-attachment:fixed;
	...
	.ainterativa {
		background:url('highlights.jpg'), url('blured2.png');
		background-size:cover;
		background-position:center;
		background-attachment:fixed;
		background-blend-mode: luminosity;
	...
	.quiz {
		background:url('bg/quiz.jpg'), url('blured5.png');
		background-size:cover;
		background-position:center;
		background-attachment:fixed;
	...
	.map {
		background:url('bg/maps.png'), url('blured8.png');
		background-size:cover;
		background-position:center;
		background-attachment:fixed;
	...
	.learn {
		background:url('bg/learn.jpg'), url('blured3.png');
		background-size:cover;
		background-position:center;
		background-attachment:fixed;
		background-blend-mode:color-dodge;
	...
	.report {
		background:url('bg/report.jpg'), url('blured4.png');
		background-size:cover;
		background-position:center;
		background-attachment:fixed;
		background-blend-mode:overlay;
	...
	.social {
		background:url('bg/redes.jpg'), url('blured7.png');
		background-size:cover;
		background-position:center;
		background-attachment:fixed;
	...
	.phone {
		background:url('bg/phone.jpg'), url('blured6.png');
		background-size:cover;
		background-position:center;
		background-attachment:fixed;
...
<body>
    ...
    <div class="content bordercolor" id="whatis">
    	<div class="containter">
        	<div class="imgicon">
            	<img src="Icon/reacting.png" class="contimg">
            </div>
            <div class="conttext">
    ...
    <div class="content bordercolor" id="AI">
    	<div class="containter">
        	<div class="imgicon" style="float:right">
            	<img src="Icon/ainterativa.png" class="contimg">
            </div>
    ...
    <div class="header ainterativa">
    	<div class="bgcont">
            ...
            <a style="animation-delay:500ms;" href="http://reagindoaomosquito.ga/interativa.php" target="_blank">Começar agora</a>
        </div>
    </div>
    <div class="content bordercolor" id="quiz">
    	<div class="containter">
        	<div class="imgicon">
            	<img src="Icon/quiz.png" class="contimg">
            </div>
            <div class="conttext">
            	<label class="ti">Quiz: Teste seus conhecimentos!</label>
                <br>
                <p>Usou nossa Aprendizagem Interativa? Já tem um conhecimento sólido sobre esse assunto? Que tal colocá-los a prova com esse minigame em forma de quiz? Aqui você tem 120 segundos para responder 12 questões aleatórias sobre o mosquito. Quanto mais questões você responder corretamente em menos tempo, maior a sua pontuação. O que me diz de  você comparar seu conhecimento com seus colegas de classe e amigos pra ver quem tira a maior pontuação? Além disso, se você tiver um <a href="http://reagindoaomosquito.ga/register.php">cadastro em nosso site</a>, sua pontuação ficará registrada em nosso sistema e os outros visitantes poderão ver que você já está por dentro do assunto, gostou?
                </p>
            </div>
            <div style="clear:both;"></div>
        </div>
    ...
    <div class="header quiz">
    	<div class="bgcont">
            ...
            <a style="animation-delay:500ms;" href="http://reagindoaomosquito.ga/120x12.php" target="_blank">Começar agora</a>
        </div>
    </div>
    <div class="content bordercolor" id="maps">
    	<div class="containter">
        	<div class="imgicon" style="float:right">
            	<img src="Icon/maps.png" class="contimg">
            </div>
            <div class="conttext right">
    ...
    <div class="header map">
    	<div class="bgcont">
            ...
            <a style="animation-delay:500ms;" href="http://reagindoaomosquito.ga/focosmap.php" target="_blank">Visitar Mapa</a>
        </div>
    </div>
    <div class="content bordercolor">
    	<div class="containter">
        	<div class="imgicon">
            	<img src="Icon/learnmore.png" class="contimg">
            </div>
            <div class="conttext">
    ...
    <div class="header learn">
    	<div class="bgcont">
            ...
            <br><br><hr>
            <br><br><br>
            <a style="animation-delay:500ms;" href="http://reagindoaomosquito.ga/articles.php?id=01" target="_blank">Visualizar Textos</a>
        </div>
    </div>
    <div class="content bordercolor" id="denuncia">
    	<div class="containter">
        	<div class="imgicon" style="float:right">
            	<img src="Icon/report.png" class="contimg">
            </div>
            <div class="conttext right">
    ...
    <div class="header report">
    	<div class="bgcont">
            ...
            <a style="animation-delay:500ms;" href="http://reagindoaomosquito.ga/trashreport.php" target="_blank">Quero Denunciar!</a>
        </div>
    </div>
    <div class="content bordercolor">
    	<div class="containter">
        	<div class="imgicon">
            	<img src="Icon/socialnetworks.png" class="contimg">
            </div>
            <div class="conttext">
