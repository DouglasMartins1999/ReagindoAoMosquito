<?php
	...
	$xml = simplexml_load_file('quests.xml');
	$xid = range(0, 16);
	shuffle($xid);
	$ans = range(0, 3);
	shuffle($ans);
...
.bg0 {
	background:url('img/quiz/bg/<?php echo $background[0];?>.jpg');
}
.bg1 {
	background:url('img/quiz/bg/<?php echo $background[1];?>.jpg');
}
.bg2 {
	background:url('img/quiz/bg/<?php echo $background[2];?>.jpg');
}
.bg3 {
	background:url('img/quiz/bg/<?php echo $background[3];?>.jpg');
}
.bg4 {
	background:url('img/quiz/bg/<?php echo $background[4];?>.jpg');
}
.bg5 {
	background:url('img/quiz/bg/<?php echo $background[5];?>.jpg');
}
.bg6 {
	background:url('img/quiz/bg/<?php echo $background[6];?>.jpg');
}
.bg7 {
	background:url('img/quiz/bg/<?php echo $background[7];?>.jpg');
}
.bg8 {
	background:url('img/quiz/bg/<?php echo $background[8];?>.jpg');
}
.bg9 {
	background:url('img/quiz/bg/<?php echo $background[9];?>.jpg');
}
.bg10 {
	background:url('img/quiz/bg/<?php echo $background[10];?>.jpg');
}
.bg11 {
	background:url('img/quiz/bg/<?php echo $background[11];?>.jpg');
}
.ask {
	background-repeat:no-repeat;
	background-size:cover;
...
.over {
	background:url('img/quiz/bgend.jpg');
	background-repeat:no-repeat;
	background-attachment:fixed;
	background-size:cover;
	background-position:center;
...
.finish {
	background:url('img/quiz/bgfinish.jpg');
	background-repeat:no-repeat;
	background-attachment:fixed;
	background-size:cover;
	background-position:center;
...
.high {
	background:url('img/quiz/bghigh.jpg');
	background-repeat:no-repeat;
	background-attachment:fixed;
	background-size:cover;
	background-position:center;
...
<script>
	...
	elem = document.getElementById("body");
		...
		if(begin == true){
			startcountdown();see('a1','home');
		}
		else if(begin == 'detail'){
			see('info','home');
		}
	}
	function see(on,off){
...
<div class="home cont" id="home">
	<img src="img/quiz/logo.png" class="logo" onClick="fullscreen();">
	<button class="beginbutton" onClick="fullscreen(true);">Começar Agora</button>
	<button class="beginbutton" style="border-bottom:1px solid #AAA" onClick="fullscreen('detail');">Saiba mais</button>
	<img src="img/quiz/ramlogo.png" class="sitelogo">
</div>
...
<div class="cont over none" id="gOver">
	<img src="img/quiz/gameover.png" class="logo" style="margin-top:27%;margin-bottom:5%" onClick="fullscreen();">
	<div class="info" style="margin-top:0;font-size:14px;">Infelizmente, você não conseguiu completar todas as perguntas antes do tempo acabar. Mas não desista! Tente novamente e aprimore seus conhecimentos.</div>
	<?php $setid = mt_rand(0,3);?>
	<div class="answers">
...
<div class="cont finish none" id="finish">
	<img src="img/quiz/sucess.png" class="logo" style="margin-top:10%;margin-bottom:5%" onClick="fullscreen();">
	<div class="info" style="margin-top:0;font-size:14px;">Sua pontuação:
...
<div class="cont high none" id="high">
	<img src="img/quiz/Highscores.png" class="logo" style="margin-top:10%;margin-bottom:5%" onClick="fullscreen();">
	<iframe frameborder="0" src="ranking.php" style="width:100%;height:60%;margin-top:20px;" id="ranking"></iframe>
	<?php $setid = mt_rand(0,3);?>
	<div class="answers">
		<button class="ans" onClick="highscoreout()" style="background:<?php echo $colorsbg[$setid] . ';color:' . $colorbg[$setid];?>">Voltar</button>
	</div>
</div>
<div class="rightwrong none" id="right"><img src="img/quiz/res/right.gif" style="width:70%;margin:15%;"></div>
<div class="rightwrong none" id="wrong"><img src="img/quiz/res/wrong.gif" style="width:70%;margin:15%;"></div>
<div class="countdown none" id="count">120</div>
<div class="menu none" id="menu">
	<img src="img/quiz/res/reload.png" style="width:40px;margin-left:4px;float:left;" onClick="tryagain()">
	<img src="img/quiz/res/exit.png" style="width:40px;margin-left:25px;float:left;" onClick="goBack()">
	<div style="clear:both;"></div>
</div>
<form action="rankingdata.php" method="post" target="frameform" id="formdata">
<input name="user" type="hidden" value="<?php echo $_SESSION["username"];?>">
<input name="points" type="hidden" id="points">
</form>
<iframe id="frameform" name="frameform"></iframe>
</body>
</html>
