...
<div class="conreg"> 
  <h1>Faça Login!</h1>
  <br>
  <form action="includes/process_login.php?url=<?php if(isset($_GET['url'])){echo $_GET['url'];}else{echo $_SERVER['PHP_SELF'];}?>" method="post" name="login_form" enctype="multipart/form-data" id="log" style="margin:0;">
  ...
  <br>
  <div class="foots"> 
    <label>Esqueci a Senha: <a href="passwordrecover.php" class="enter">Recuperar agora</a></label>
    <br>
    <label>Não possui conta? <a href="register.php">Registre-se agora!</a></label>
  </div>
</div>
</body>
</html>
