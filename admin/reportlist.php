    ...
    <?php 
		if ($result->num_rows > 0) {
			...
			while($row = $result->fetch_assoc()) {
				$fileimg = "../img/reportimgs/" . $row["reportid"] . $row["filetype"];
				...
				if($saw == ""){
					$see = "<img src='img/received.png' align='left'> Entregue";
					$colorsaw = "#888";
				}
				elseif($saw == "false"){
					$see = "<img src='img/saw.png' align='left'> Visualizada";
					$colorsaw = "#059";
				}
				elseif($saw == "true"){
					$see = "<img src='img/acepted.png' align='left'> Respondida";
					$colorsaw = "#090";
				}
