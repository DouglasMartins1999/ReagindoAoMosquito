...
.home {
	background:url('img/quiz/pc/bg.jpg');
...
<div style="width:800px;height:480px;overflow:hidden;">
	<div class="home cont" id="home">
		<img src="img/quiz/pc/logo.png" class="logo" onClick="fullscreen();">
	...
	<div class="cont over none" id="gOver" style="position:absolute;">
		<img src="img/quiz/gameover.png" class="logo" style="margin-top:17%;margin-bottom:5%" onClick="fullscreen();">
	...
	<div class="cont high none" id="high" style="position:absolute;">
		...
		<iframe frameborder="0" src="ranking.php" style="width:100%;height:55%;margin-top:20px;" id="ranking"></iframe>
		<?php $setid = mt_rand(0,3);?>
	...
	<form action="rankingdata.php" method="post" target="frameform" id="formdata" style="position:absolute;top:0;">
