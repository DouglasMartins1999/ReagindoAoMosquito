<?php
	...
	$target_dir = "/assets/images/reportimgs/";
		...
		// if everything is ok, try to upload file
			...
			if (move_uploaded_file($uploadfile["tmp_name"], $target_file)) {
				...
				if ($mysqli->query($sql) === TRUE) {
					require_once('../assets/libraries/server/pushpad/init.php');
					Pushpad\Pushpad::$auth_token = $_ENV["PUSH_TOKEN"];
					Pushpad\Pushpad::$project_id = $_ENV["PUSH_PROJID"];
					...
					$url = $_ENV["BASE_URL"] . "/admin/adminreport.php?id=" . $id;
